...
### ■ サーバー常駐時間をコントロールしてシステムの動作を安定化。
  ...
  ```
- [mod7.6a BSAlmighty+DeltaHz+DefSpace+PTx+PTxScanS+SparePTw+UseHRTimer+SrvDeactWait fixes](https://github.com/hyrolean/BonDriver_PTx-ST_mod/releases/tag/mod7.6a)
